...
let queries = {
        ...
        getDeletedListMessages: new PS('get-messages','SELECT me.*,us.users_id, us.users_username, us.users_name FROM conversations_users cu INNER JOIN USERS us ON us.users_id = cu.users_id INNER JOIN message me ON cu.conversations_id = me.conversations_id WHERE me.conversations_id = $1 AND me.created_at > $2 ORDER BY me.created_at'),
        getListMessages: new PS('get-messages','SELECT me.*,us.users_id, us.users_username, us.users_name FROM MESSAGE me INNER JOIN USERS us ON us.users_id = me.users_id WHERE me.conversations_id = $1 ORDER BY me.created_at'),
