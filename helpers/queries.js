...
let queries = {
        ...
        getListConversation: new PS('get-chats','select co.* from conversations co inner join conversations_users cu on co.conversations_id = cu.conversations_id WHERE is_deleted is null and users_id = $1 OR is_deleted = false AND users_id = $1'),
        ...
        createMessage: new PS('create-message','INSERT INTO MESSAGE (users_id, conversations_id, message_attachment, message_body, created_at, is_deleted) VALUES ($1, $2, $3, $4, $5) RETURNING *'),
